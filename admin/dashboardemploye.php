   ...
   <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: rgb(33,37,41);background: rgb(33,37,41);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="ajout_utilisateur.php"><i class="fa fa-plus"></i><span style="font-family: Lato, sans-serif;">Demande d'inscription</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="ajoutlivre.php"><i class="fa fa-plus"></i><span style="font-family: Lato, sans-serif;">Ajouter un livre au catalogue</span></a></li>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                                ...
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">3+</span><i class="fas fa-bell fa-fw"></i></a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 class="dropdown-header">Centre de notifications</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                            ...
                                            <div><span class="small text-gray-500">10-10-2021</span>
                                ...
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">7</span><i class="fas fa-envelope fa-fw"></i></a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 class="dropdown-header">Vos messages</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="/admin/assets/img/avatars/avatar4.jpeg">
                                                <div class="bg-success status-indicator"></div>
                                            </div>
                                            <div class="fw-bold">
                                                <div class="text-truncate"><span>Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum</span></div>
                                                <p class="small text-gray-500 mb-0">Lorem Ipsum</p>
                                            </div>
                                        </a><a class="dropdown-item d-flex align-items-center" href="#">
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="admin/assets/img/avatars/avatar2.jpeg">
                                            ...
                                            <div class="fw-bold">
                                                <div class="text-truncate"><span>Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum</span></div>
                                                <p class="small text-gray-500 mb-0">Lorem Ipsum Lorem Ipsum</p>
                                            </div>
                                        </a><a class="dropdown-item d-flex align-items-center" href="#">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small" style="font-family: Lato, sans-serif;"><?php echo $_SESSION['nom']; ?> <!-- </span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg"> --> </a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="ajout_utilisateur.php"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Demande d'inscription</a><a class="dropdown-item" href="ajoutlivre.php"><i class="fas fa-cogs fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Ajouter un livre au catalogue</a> <!-- <a class="dropdown-item" href="catalogue.php"><i class="fas fa-list fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Voir le catalogue</a> -->
                                        <div class="dropdown-divider"></div><a class="dropdown-item" href="../login.php"><i class="fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Déconnexion</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
